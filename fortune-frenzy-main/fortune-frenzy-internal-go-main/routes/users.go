...
func SetupUserRoutes(app *fiber.App) {
	...
	users.Post("/:userId/wallet/bootstrap", auth, handlers.BootstrapWallet)
	users.Get("/:userId/wallet", auth, handlers.GetWallet)
	users.Post("/:userId/wallet/adjust", auth, handlers.AdjustWallet)
