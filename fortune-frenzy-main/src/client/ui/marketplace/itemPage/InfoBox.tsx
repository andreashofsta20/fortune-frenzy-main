...
export function ItemPageSubBox({ image, color, title, subtitle, LayoutOrder = 1, size }: Props) {
	const px = usePx();

	return (
		<frame
			BackgroundColor3={palette.background2}
			Size={size ?? new UDim2(0, px(207), 1, 0)}
		...
		>
			...
			<imagelabel
				...
				Position={new UDim2(0, px(16), 0.5, 0)}
			...
			<TextLabel
				...
				native={{
					...
					Position: new UDim2(0, px(120), 0.5, -px(7)),
			...
			<TextLabel
				...
				native={{
					...
					TextSize: px(15),
					TextXAlignment: Enum.TextXAlignment.Left,
					Position: new UDim2(0, px(120), 0.5, px(11)),
